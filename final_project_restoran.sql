...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2023 at 09:04 AM
...
--
-- Database: `final_project_restaurant kelompok`
--
...
(3, 'Fauz Maulana', 'Kasir', 'Cand Gebang 2', 1200.00),
(4, 'Widi Saputra', 'Koki', 'Cand Gebang 3', 5000.00),
(5, 'Angga Malik', 'Kasir', 'Cand Gebang 4', 3000.00),
(6, 'Iqbal Febriana', 'Kasir', 'Cand Gebang 5', 5000.00),
(7, 'Fauz', 'Kasir', 'Candi Gebang 3', 6000.00);
...
--
-- Dumping data for table `karyawan_log`
--

INSERT INTO `karyawan_log` (`id_karyawan`, `nama_karyawan`, `jabatan`, `alamat`, `gaji`) VALUES
...
(17, 28, '2023-07-20 08:58:25', 2000, 6, 16);
...
--
ALTER TABLE `pesanan_menu`
  MODIFY `id_pesanan_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
